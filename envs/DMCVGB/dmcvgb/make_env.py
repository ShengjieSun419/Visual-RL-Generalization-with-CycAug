...
def make_env(domain_name, task_name, seed, action_repeat=2, frame_stack=3, type='original', difficulty='easy', intensity=0, is_distracting_cs=False):
    ...
    cfg_dict['intensity'] = intensity
    cfg_dict['is_distracting_cs'] = is_distracting_cs
    print("in make env, cfg_dict is:")
    print(cfg_dict)
